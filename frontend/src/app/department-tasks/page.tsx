...
import { MOCK_TASKS, getCurrentUser } from "@/lib/mock-data";
...
export default function DepartmentTasksPage() {
  ...
  useEffect(() => {
    ...
    const deptTasks = MOCK_TASKS.filter(t => t.department === currentUser.department);
    setTasks(convertMockTasksToUITasks(deptTasks));
  }, []);
